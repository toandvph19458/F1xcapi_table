  ...
  <div class="header">
    <div class="header-marquee">
      ...
      <div class="header-marquee__list">
        ...
        >
          <div v-for="i in 10" :key="i" class="header-marquee__item">
    ...
    <div class="header-filter">
      ...
      <div class="menu-right">
        ...
        <div class="menu-button">
          <div class="header-filter__box"></div>
          <div class="header-filter__btn" @click="toggle">Hợp tác</div>
          <div class="header-filter__line"></div>
          <div class="header-filter__btn" @click="toggle">Bộ lọc</div>
        </div>
